...
public class TIME extends HttpServlet {
    ...
    //また，２回目以降のアクセス時は，クッキーの値を取り出し，前回にアクセスした時刻の情報を画面に表示してください.    
        ...
        String timenow=now1.format(now);
        
        //エンコード化
        String encodedData=URLEncoder.encode(timenow,"UTF-8");
        Cookie en=new Cookie("time",encodedData);
        
        
        //Cookieに現時刻を書き込む
        //Cookie time2=new Cookie("time",timenow);
        //Cookieに反映
        response.addCookie(en);
